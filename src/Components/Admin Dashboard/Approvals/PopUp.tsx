    ...
    <Dialog open={open} onClose={onClose} >
      ...
      <DialogTitle sx={{padding: "0px"}}>Workflow</DialogTitle>
        <TextField
          ...
          sx={{ minWidth: "450px" }}
        />
        <Button variant="contained" color="primary" onClick={handleAddItem} style={{ marginTop: '8px', marginBottom: "8px" }}>
          Add
        </Button>
        {items?.length > 0 ? 
        <>
        <Divider sx={{ marginTop: "8px",  marginBottom: "16px" }}/>
        <DialogTitle sx={{padding: "0px", marginTop: "8px",  marginBottom: "16px"}}>Edit Workflow</DialogTitle>
        {/* Popup content */}
