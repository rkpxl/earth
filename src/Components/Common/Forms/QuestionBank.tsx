...
import { Box, CircularProgress, Grid, Radio, RadioGroup, Step, StepLabel, Stepper, Typography } from '@mui/material';
...
const QuestionBank = (props: QuestionBankProps) => {
  const {isDisabled, title, result, description,dept, questions,
    handleAnswerChange,setValue, setResult, isView = false } = props
