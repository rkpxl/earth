...
export const QuestionList: React.FC<FormProps> = ({ title, dept, description }) => {
  ...
  const questions: Array<Question> = [
    ...
    {
      id: 3,
      question: '3. Enumerate the anticipated advantages resulting from the research.',
      answer: '',
      options: {},
    },
    {
      id: 4,
      question: '4. Provide an estimated completion date for the entire research study.',
      answer: '',
      options: {},
    },
    {
      id: 5,
      question: '5. Describe the measures taken to minimize and manage these risks.',
      answer: '',
      options: {},
    },
    {
      id: 6,
      question: '6. Assess the potential economic impact on the study participants.',
      answer: '',
      options: {},
    },
    {
      id: 7,
      question:
        '7. Outline the sequential actions the research team will undertake with recruited and consented participants.',
      answer: '',
      options: {},
    },
    {
      id: 8,
      question: '8. Identify potential risks to study participants.',
      answer: '',
      options: {},
    },
    ...
    {
      id: 10,
      question: '10. Indicate whether the study encompasses participants under the age of ?',
      answer: '',
      options: {},
    },
    {
      id: 11,
      question: '11. How long do you anticipate it will take to enroll all study participants?',
      answer: '',
      options: {},
    },
    ...
    {
      id: 13,
      question: '13. Confirm who will have the chance to review their data.',
      answer: '',
      options: {},
    },
    {
      id: 14,
      question: '14. Are there any planned surveys or interviews?',
      answer: '',
      options: {},
    },
    {
      id: 15,
      question: '15. Will genetic testing be conducted as part of the study?',
      answer: '',
      options: {},
    },
  ]
  ...
  useEffect(() => {
    ...
    axios
      .post(process.env.NEXT_PUBLIC_HOST_URL + '/users/usersOf', {
  ...
  const uploadDoc = async (doc: any) => {
    ...
    try {
      const response = await axios.post(
        process.env.NEXT_PUBLIC_HOST_URL + '/tasks/upload',
        formData,
        {
          headers: {
  ...
  const submitHandle = async (e: any) => {
    ...
    if (reviewer) {
      ...
      updateComment()
      axios
        .post(process.env.NEXT_PUBLIC_HOST_URL + '/tasks', {
    ...
    <>
      ...
      <Box sx={{ width: '100%' }}>
        <SearchPeople
          ...
          onClose={toggelSearchBarToAddPerson}
        />
        ...
        <CustomTabPanel value={value} index={2}>
          <DocumentTab documents={documents} setDocuments={setDocuments} isDisabled={false} />
        </CustomTabPanel>
